    ...
    <TooltipProvider>
      ...
      <Card className="w-full max-w-md shadow-xl border-0 bg-white/90 dark:bg-[#0f1629]/90 backdrop-blur-xl relative z-10">
        ...
        <CardHeader className="text-center space-y-2 relative">
          ...
          <CardDescription>Sign in to access your expense tracker</CardDescription>
        </CardHeader>
        <CardContent className="relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Tooltip>
                ...
                <TooltipContent>Enter your password</TooltipContent>
              </Tooltip>
            </div>
            ...
            <Tooltip>
              ...
              <TooltipContent>Sign in with your email and password</TooltipContent>
            </Tooltip>
          </form>
          ...
          <Tooltip>
            ...
            <TooltipContent>Sign in with your Google account</TooltipContent>
          </Tooltip>
